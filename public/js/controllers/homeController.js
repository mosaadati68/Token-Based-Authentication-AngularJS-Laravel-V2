myApp.controller('homeController', [
    '$scope', '$location', 'productModel', '$timeout', '$routeParams', 'Lightbox', 'cartModel',
    function ($scope, $location, productModel, $timeout, $routeParams, Lightbox, cartModel) {
        ...
        angular.extend($scope, {
            addProductToCart: function (productId) {
                ...
                cartModel.addToCart(data).then(function (response) {
